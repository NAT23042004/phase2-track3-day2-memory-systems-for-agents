...
class SemanticMemory(BaseMemory):
    def __init__(self, collection_name="user_knowledge"):
        ...
        self.collection = self.client.get_or_create_collection(name=collection_name, embedding_function=self.openai_ef)
    ...
    def clear(self) -> None:
        ...
        self.collection = self.client.get_or_create_collection(
            name=self.collection.name, embedding_function=self.openai_ef
        )
